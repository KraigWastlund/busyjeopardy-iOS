...
class Questions {
    ...
    static let question2 = JeopardyQuestion(x: 0, y: 1, question: "After begin denied the rank of Jedi Master, this Jedi Knight defected to the dark side of the force, becoming one of the galaxy's most fearsome villains.", image: nil, videoName: nil)
    ...
    static let question25 = JeopardyQuestion(x: 4, y: 0, question: "Prior to his discovery that his father was a Jedi Knight, Luke thought his father's occupation was this.", image: nil, videoName: nil)
    static let question26 = JeopardyQuestion(x: 4, y: 1, question: "The age that Yoda was when he became one with the force.", image: nil, videoName: nil)
    static let question27 = JeopardyQuestion(x: 4, y: 2, question: "It's the name of the planet where the Empire had their final battle, as well as where we first meet a certain highly force-sensitive scavenger", image: nil, videoName: nil)
    static let question28 = JeopardyQuestion(x: 4, y: 3, question: "The name of Jabba the Hutt's court jester, known for his shrill laughter.", image: nil, videoName: nil)
    static let question29 = JeopardyQuestion(x: 4, y: 4, question: "While aboard the Death Star, Luke assumes the identity of a stormtrooper with this call sign.", image: nil, videoName: nil)
    static let question30 = JeopardyQuestion(x: 4, y: 5, question: "The name of the Imperial Shuttle stolen by the Rebel Alliance to infiltrate the moon of Endor.", image: nil, videoName: nil)
    
    // sixth cat - CREATURES
    static let cat6Title = "CREATURES"
    static let question31 = JeopardyQuestion(x: 5, y: 0, question: "The most well known of this species is Chewbacca.", image: nil, videoName: nil)
    static let question32 = JeopardyQuestion(x: 5, y: 1, question: "With the looks of a cross between a teddy bear and a shih tzu, these creatures are native to the moon of Endor.", image: nil, videoName: nil)
    static let question33 = JeopardyQuestion(x: 5, y: 2, question: "These animals were created by the production team out of necessity, due to the large amount of puffins on Skellig Micheal while filming scenes in 'The Last Jedi'", image: nil, videoName: nil)
    static let question34 = JeopardyQuestion(x: 5, y: 3, question: "Jabba the Hutt keeps one of these creatures in his dungeon, often feeding it prisoners.", image: nil, videoName: nil)
    static let question35 = JeopardyQuestion(x: 5, y: 4, question: "These creatures are parasites that chew on power cables and energy conductors of starships.", image: nil, videoName: nil)
